...
describe('NewTaskPage', () => {
  ...
  it('should save todo with correct values and navigate to todos', () => {
    ...
    expect(createTodoUseCase.execute).toHaveBeenCalledWith('Nueva tarea', 'B', 'Completado');
  ...
  it('should trim title before saving', () => {
    ...
    expect(createTodoUseCase.execute).toHaveBeenCalledWith('Tarea con espacios', 'A', 'Pendiente');
  });
